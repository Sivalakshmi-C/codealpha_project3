...
const Portfolio = () => {
  return (
    <div className="bgimg">
      <nav>
        <ul>
          <li><a href="#home" className="logo">Siva lakshmi.</a></li>
      ...
      <div id="home" className="main">
        <div className="text">
          <h2>HEY THERE!</h2>
          <h1 style={{ margin: '5px' }}>I am <span className="Special">C.Siva lakshmi.</span></h1>
          <pre style={{ fontFamily: 'Times New Roman, Times, serif' }}>But you can call me --<span className="Special"><b> siva
            </b></span></pre>
          <p><b>I'm currently a student at Annmacharaya institution.</b></p>
          <br /><a href="SIVA LAKSHMI M1.docx" download>Download CV</a>
        </div>
        ...
        <div className="time">
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I Completed my School Education at Z.P.H.SCHOOL,peddamallepalli,Tadipatri</p>
          ...
          <div className="con rig">
            ...
            <div className="text-box">
              ...
              <p>I Completed my Intermediate Education at Sir C.V.Raman junior college,Ananthapur.</p>
              <p>I got 9.6 CGPA in my Intermediate Education.</p>
          ...
          <div className="con lef">
            ...
            <div className="text-box">
              ...
              <p>I got 9.25 CGPA in my Bachelor's Education.</p>
              <span className="lef-arr"></span>
            </div>
          </div>
        </div>
        ...
        <address>
          <div className="add">
            <div className="contact">
              ...
              <p>Address: 1-172,<br /> 85 Nittur,<br /> yellanur(M),<br /> Ananthapur(D),<br /> Andhra Pradesh state.</p>
            </div>
            <div className="contact">
              <h2><span className="special">Contact me</span></h2><hr />
              <p><b>Email:</b> <a href="mailto:csivalakshmi9@gmail.com">csivalakshmi9@gmail.com</a></p>
              <p><b>Phone:</b> <a href="tel:+91 8919427833">8919427833</a></p>
            </div>
          </div>
